...
app.get('/api/config/status', (req, res) => {
  res.json({
    ...
    session: { active: false, message: 'Operando via API nativa' },
  });
});

// Diagnóstico limpo
app.get('/api/debug/sintetico', async (req, res) => {
  res.json({ message: "Utilize o endpoint /api/test-pacto para testar sua conectividade com a API oficial." });
});
